...
export default function personalSpect() {
    ...
    const spect = {id:1, name:'Малыш и карлсон', author: 'Астрид Линдгрен', director: 'Сергей Романюк', discription: 'good spect', time: '2:00', children: true, mainPhoto: 'https://akimovkomedia.ru/files/local/CMS_File/h0000/8915/8915.BigImg.jpg?1683121393', host: false}
    return (
        <div>
            <MediaQuery minWidth={1280}>
                <div class="spect">
                    <img src={spect.mainPhoto} />
